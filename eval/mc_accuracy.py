...
if __name__ == '__main__':
    ...
    # data paths
    parser.add_argument('--answer_path', type=str, default='./data/model/task1/task1_MC_testset.jsonl')
    parser.add_argument('--prediction_path', type=str, default='./data/input/task1/task1_MC_testset.jsonl')
